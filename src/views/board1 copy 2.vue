			...
			<template #header>
                <div class="p-grid p-nogutter">
                    <div class="p-col-6" style="text-align: left">
						...
						:options="sortOptions" optionLabel="label" placeholder="Sort By Price" 
				...
				<div class="p-col-12">
					<div class="product-list-item">
						<div class="product-list-detail">
							...
							<Rating :modelValue="listview.data.rating" :readonly="true" :cancel="false"></Rating>
